	...
	<v-container class="mt-10">
		...
		<v-card elevation="4" class="rounded-lg">
			...
			<v-row class="pa-4 justify-center">
					...
					<v-row class="flex-column" dense>
						...
						<v-row active-class="primary--text" class="justify-space-between">
							...
							<v-col cols="6" xxl="8" md="3" sm="3" lg="3" xl="3" xs="5">
								<!-- Cambia a 6 columnas en dispositivos móviles -->
								<v-text-field class="rounded-lg text-center align-center align-items" label="Otros" solo flat full-width v-model="otroPlazo"
									:rules="plazoRules" hide-details @focus="handleTextFieldFocus"
									@blur="handleTextFieldBlur" @input="handleInputOtroPlazo"
									@keypress="handleKeyPressAmount"
				...
				<v-col cols="11 mt-5" sm="8" md="7" lg="7" xl="7">
					<v-row class="justify-center " grid-List-md>
						<v-row class="justify-center">

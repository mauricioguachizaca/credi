    ...
    <div>
        <v-row justify="center">
            <v-col rows="2" class="mt-10 mb-10" md="5" sm="5" xs="5">
                ...
                <v-img class="img_pincipal2" alt="hola avatar" :src="homeImage" />

            </v-col>
            <v-col rows="2" style="text-align: justify;" class="mt-10 mb-10" md="3" sm="5" xs="5">
                <h2 class="mt-5 initial">¡Tu solicitud de crédito ingresó con éxito!</h2><br />

                <body-1>Hola, <b>Amigo</b> </body-1><br />
                ...
                <row style="text-align: center;">
                    <p><br /> <b>Monto solicitado</b> <br />$2.000.00 </p>
                    <p> <b>Número de solicitud</b><br /> 1105490819</p>
                    <p> <b>Fecha de solicitud</b><br /> 02/12/2022 </p>
                    <p> <b>Código personal de seguimiento de crédito </b><br /> 120293847729202890129</p>
                </row>
            </v-col>
        </v-row>
...
import homeImg from '@/assets/img/exito.jpg'
